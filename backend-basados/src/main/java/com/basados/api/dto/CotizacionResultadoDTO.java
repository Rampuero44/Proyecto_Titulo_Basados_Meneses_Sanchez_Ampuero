...
public class CotizacionResultadoDTO {
    ...
    public Integer getProductosEncontrados() { return productosEncontrados; }
    public void setProductosEncontrados(Integer productosEncontrados) { this.productosEncontrados = productosEncontrados; }

    public Integer getProductosFaltantes() { return productosFaltantes; }
    public void setProductosFaltantes(Integer productosFaltantes) { this.productosFaltantes = productosFaltantes; }
