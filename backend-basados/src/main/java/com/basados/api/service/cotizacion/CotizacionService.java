        ...
        private CotizacionResultadoDTO generarCotizacion(
                ...
                for (CotizacionProductoDTO item : request.getProductos()) {
                        ...
                        Producto producto = productoRepository.findById(
                                        item.getIdProducto()).orElse(null);
                        ...
                        Optional<HistorialPrecio> historialOpt = historialPrecioRepository
                        ...
                        if (historialOpt.isPresent()) {
                                ...
                                itemDTO.setIdHistorial(
                                                historial.getIdHistorial());

                                itemDTO.setComercio(
                                                historial.getComercio() != null
                                                                ? historial.getComercio().getNombre()
                                                                : null);
