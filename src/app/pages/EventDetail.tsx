              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex justify-between py-2">
                    <span className="font-semibold">Suma de aportes</span>
                    <span className="font-bold text-lg text-primary">{formatPrice(totalAportes)}</span>
                  </div>
                  <div className="flex justify-between rounded-lg bg-muted p-3">
                    <span className="font-medium">Promedio por persona</span>
                    <span className="font-bold text-primary">
                      {formatPrice(evento.cantidadPersonas ? totalAportes / evento.cantidadPersonas : 0)}
                    </span>
                  </div>
                </CardContent>
              </Card>
